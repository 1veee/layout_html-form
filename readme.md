# HTML form
Replace `1veee` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://1veee.github.io/layout_html-form/)
- [TEST REPORT LINK](https://1veee.github.io/layout_html-form/report/html_report/)
